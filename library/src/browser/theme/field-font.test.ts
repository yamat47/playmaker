...
import { FIELD_FONT_FAMILY, fieldFont } from "./field-font.js";
...
describe("fieldFont", () => {
  it("同梱フォントの太さと指定した px の大きさで、ctx.font の値を組み立てる", () => {
    expect(fieldFont(12)).toBe('700 12px "Playmaker Saira", sans-serif');
  });
});
